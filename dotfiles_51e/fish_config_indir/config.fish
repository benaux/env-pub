...
set -l homebins $HOME/builds/bin $HOME/.local/bin $HOME/opt/bin $HOME/.bin $HOME/.pub-cache/bin $ANDROID_SDK/tools $ANDROID_SDK/tools/bin $ANDROID_SDK/platform-tools $ANDROID_NDK $HOME/.cargo/bin $HOME/tools/python/bin $HOME/Library/Python/3.7/bin $HOME/.local/bin
